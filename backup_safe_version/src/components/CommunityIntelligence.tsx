        ...
        <div style={{
          ...
          <div>
            <div style={{
              ...
              <Users size={14} />
              <span>Crowdsourced Threat Network (Demo Dataset)</span>
            </div>
            <h2 style={{ fontSize: 'clamp(1.8rem, 3.5vw, 2.4rem)', fontWeight: 800, color: '#f8fafc', marginBottom: '0.35rem' }}>
              Community Scam Intelligence
            </h2>
            <p style={{ color: '#94a3b8', fontSize: '0.92rem', maxWidth: '680px', lineHeight: 1.45 }}>
              Warnings submitted by shoppers across India (Prototype Demo Dataset). Search reported UPI IDs, 
